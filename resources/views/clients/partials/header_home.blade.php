                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="ltn__top-bar-menu">
                                <ul>
                                    <li><a href="locations.html"><i class="icon-placeholder"></i> Đống Đa, Hà Nội</a></li>
                                    <li><a href="mailto:hongquan@gmail.com?Subject=Contact%20with%20to%20you"><i
                                                class="icon-mail"></i> hongquan@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="site-logo-wrap">
                                <div class="site-logo">
                                    <a href="index.html"><img src="{{asset('assets/clinets/img/logo.png')}}" alt="Logo"></a>
                                </div>
                            </div>
                        </div>
...
@include('clients.partials.utillize_mobile')
