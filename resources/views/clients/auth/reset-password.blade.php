            ...
            <div class="ltn_form-box">
                <form action="{{route('password.update')}}" method="POST" id="reset-password-form">
                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="password" name="password_confirmation" placeholder="Xác nhập mật khẩu mới" required>
                    ...
                    <div class="btn-wrapper">
                        <button 
                            type="submit" class="theme-btn-1 btn black-btn text-uppercase">Đặt lại mật khẩu</button>
                    </div>
                </form>
            </div>
        </div>
